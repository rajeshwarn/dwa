@extends('index_mobile')
	...
	@section('content')
		...
		<section>
			<div class="container">
				<div id="main-content">
					<div class="featured-movie-wrap box">
						<h2 class="title">Featured Movie</h2>

						<div id="featured-movie-wrap" class="movie-wrap">
					...
					<div class="latest-upload-wrap box">
						<h2 class="title">Latest Uploads Movie</h2>

						<div id="latest-upload-wrap" class="movie-wrap">
