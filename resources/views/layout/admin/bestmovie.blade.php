@extends('indexadmin')
	...
	@section('contentadmin')
			...
			<div class="container-fluid">
				<div class="row admin-row">
							...
							<ul>
								<li class="selected"><a href="movie"><i class="fa fa-film" aria-hidden="true"></i></i> Movies</a>
									<ul>
										...
										<li class="selected"><a href="best-movie">Best Movies</a></li>
					...
					<div class="col-md-10 right-dashboard">
						...
						<button type="button" class="btn btn-default btn-add-best-movie" data-toggle="modal">Add Best Movie</button>

						<div class="best-movie-wrap">
							<ul>
								@foreach( $bestmovie as $item )
									<li>
										<span class="movie-title">{{ $item->title }}</span>
										<a href="delete-best-movie/{{ $item->id }}" class="btn-trash-best-movie"><i class="fa fa-trash" aria-hidden="true"></i></a>
									</li>
								@endforeach
							</ul>
						</div>
		...
		<div id="modal-best-movie" class="modal fade" role="dialog">
		  <div class="modal-dialog">

		    <div class="modal-content">
				<div class="modal-header">
					<h4 class="modal-title">Select 3 Movie for Best Category</h4>
				</div>
