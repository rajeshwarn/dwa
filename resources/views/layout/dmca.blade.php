			...
			<div class="container">
				<div class="row">
					<div class="col-md-9 movie-col">
						<div class="page-wrap">
							<h1 class="page-title">Digital Millennium Copyright Act (DMCA)</h1>
							<p>
								Dewabioskop21.com adalah website online penyedia jasa sesuai dalam Digital Millennium Copyright Act (DMCA).
								<br><br>
								Dewabioskop21.com sangat menghormati dan mendukung hukum hak cipta untuk hasil karya setiap individu ataupun lembaga.
								<br><br>
								Apabila anda adalah pemilik dan pemegang hak cipta dari konten yang ada didalam website Dewabioskop21.com dan anda keberatan/tidak mengizinkan penggunaan konten tersebut, maka kami sangat terbuka untuk komplain yang anda ajukan dengan pemberitahuan secara tertulis melalui email kepada dewabioskop21.dmca@gmail.com agar kami dapat meninjau kembali dan mengambil tindakan yang diperlukan.
								<br><br>
								Dewabioskop21.com tidak dapat mengambil apapun apabila anda tidak memberikan komplain dan konfirmasi terkait konten tersebut. Maka dari itu, silahkan anda sebagai pemilik konten menbgirimkan email dengan berisikan informasi-informasi yang kami perlukan agar dapat mengambil tindakan yang tepat.
								<br><br>
								Adapun lampiran informasi sebagai berikut :
								<ol>
									<li>Data diri anda lengkap dengan alamat dan cantact person yang dapat dihubungi.</li>
									<li>Spesifikasi konten yang telah Dewabioskop21.com langgar hak ciptanya</li>
									<li>Apabila anda mengklaim terdapat lebih dari satu konten yang Dewabioskop21.com langgar hak ciptanya, maka silahkan menuliskan konten-konten tersebut dalam sebuah daftar dan menyertakan alamat website yang memuat konten tersebut lengkap dengan klaim dari hak cipta anda.</li>
								</ol>
								Jika anda serius dan percaya akan klaim yang anda ajukan, maka kirimkan email tersebut secara personal dan tidak melalui pihak ketiga (teman, keluarga, agen, dll). Apabila anda memahami dan mengikuti aturan tersebut, maka kami akan selalu terbuka dan berusaha menyelesaikan semua permasalahan secara kekeluargaan.
								<br><br>
								Semua informasi yang anda lampirkan harus detail, akurat dan terpercaya berdasarkan hukum hak cipta yang berlaku.
							</p>
						</div>
					</div>
										...
										<div class="item" itemscope itemtype="http://schema.org/Movie">
											...
											<div class="right">
												<div class="duration-wrap">
													...
													<a data-link="{{ $y_link_final or ''  }}" class="btn-trailer" itemprop="trailer">Trailer</a>
												</div>
											</div>
										</div>
									@endforeach
