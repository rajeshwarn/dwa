										...
										<div class="item" itemscope itemtype="http://schema.org/Movie">
											<div class="movie-thumb" style="background-image: url('{{ 'http://s1.dewabioskop21.com' . '/' . $movie->featured_image }}')" itemprop="image">
												...
												<div class="menu-list-wrap">
													<ul>
														<li><a href="{{ URL::to('/film') . '/' . $movie->slug_id }}" itemprop="url"><i class="fa fa-play" aria-hidden="true"></i> <span>Watch</span></a></li>
										...
										<div class="item" itemscope itemtype="http://schema.org/Movie">
											...
											<div class="right">
												<div class="duration-wrap">
													...
													<span class="movie-year" itemprop="ratingValue">Year <br>{{ $movie->year }}</span>
